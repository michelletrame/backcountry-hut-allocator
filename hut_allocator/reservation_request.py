...
class ReservationRequest:
    ...
    def __init__(self, user_name, preference_rank, hut_name, start_date, end_date, party_size):
    ...
    def __repr__(self):
        ...
        return f"{self.user_name} (P{self.preference_rank}): {self.hut_name}, {self.start_date.strftime('%Y-%m-%d')} to {self.end_date.strftime('%Y-%m-%d')}, {self.party_size} people [{status}]"
